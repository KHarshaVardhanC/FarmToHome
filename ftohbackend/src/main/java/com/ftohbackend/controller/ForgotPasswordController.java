...
//    }
	...
	@PostMapping("/verifyEmail/{userType}/{email}")
	public ResponseEntity<Map<String, String>> sendOtp(@PathVariable String userType, @PathVariable String email)
		...
		MailBody mail = new MailBody(email, "OTP for Password Reset",
	...
	public ResponseEntity<String> resetPassword(@RequestBody PasswordResetRequest request) throws SellerException {
		...
		if (userType.equals("customer")) {
			...
			if (seller == null) {
				return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Seller with email " + email + " not found.");
			}
