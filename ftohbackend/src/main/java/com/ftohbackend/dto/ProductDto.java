...
public class allProductDto {
	...
	public allProductDto(Integer product_id, String seller_id, Double product_price, String product_name,
	...
	public allProductDto() {
		super();
		// TODO Auto-generated constructor stub
	}
	@Override
	public String toString() {
		return "allProductDto [product_id=" + product_id + ", seller_id=" + seller_id + ", product_price="
