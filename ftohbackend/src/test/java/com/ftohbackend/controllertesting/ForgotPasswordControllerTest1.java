...
public class ForgotPasswordControllerTest1 {
    ...
    @Test
    public void testSendOtp_CustomerExistsSuccess() throws Exception {
        // Arrange
    ...
    @Test
    public void testSendOtp_SellerExistsSuccess() throws Exception {
        // Arrange
    ...
    @Test
    public void testSendOtp_CustomerNotFound() throws Exception {
        // Arrange
    ...
    @Test
    public void testSendOtp_SellerNotFound() throws Exception {
        // Arrange
    ...
    @Test
    public void testSendOtp_InvalidUserType() throws Exception {
        // Act & Assert
    ...
    @Test
    public void testVerifyOtp_NoOtpGenerated() throws Exception {
        // Act & Assert
        String email = "test@example.com";
        int otp = 123456;
    ...
    @Test
    public void testVerifyOtp_OtpExpired() throws Exception {
        // Arrange
        String email = "test@example.com";
        int otp = 123456;
    ...
    @Test
    public void testResetPassword_Customer_Success() throws Exception {
        // Arrange
    ...
    @Test
    public void testResetPassword_Seller_Success() throws Exception {
        // Arrange
    ...
    @Test
    public void testResetPassword_OtpNotVerified() throws Exception {
    ...
    @Test
    public void testResetPassword_SellerNotFound() throws Exception {
        // Arrange
        testResetRequest.setEmail("seller@example.com");
        testResetRequest.setUserType("seller");
    ...
    @Test
    public void testResetPassword_InvalidUserType() throws Exception {
        // Arrange
